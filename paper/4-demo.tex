...
This chapter is intended to demonstrate the function of the computer as per defined in section \ref{sec:goal} by running at first simple well known algorithms \cite{chatgptalgoidea}, and finally demonstrating Turing equivalence by implementing a \textit{Brainfuck} interpreter. % Nope it wasn't chatgpt, it was THC.
